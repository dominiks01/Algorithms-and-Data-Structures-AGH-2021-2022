...
# D (szerokosc), N (ilosc), H (wysokosc), M (max. woda), W (max. wartosc), LIMIT WODY, WYNIK
  (5, 4, 4, 50, 15, 32, 28),
  (5, 15, 5, 50, 50, 154, 365),
  (5, 25, 5, 50, 50, 264, 548),
  (10, 25, 5, 50, 50, 205, 504),
  (25, 50, 20, 70, 50, 939, 1119),
  (50, 50, 50, 100, 50, 1169, 1159),
  (100, 100, 50, 120, 50, 2619, 2159),
  (150, 250, 50, 50, 50, 3075, 5217),
  (100, 400, 50, 10, 50, 1213, 8301),
